...
export class EditorTab extends React.PureComponent<Props, State> {
  ...
  private async onSave(): Promise<void> {
    // TODO decide what devworkspace should do here and when to show the dialog depending on status
    if (isWorkspaceV1(this.props.workspace.ref) || this.props.workspace.status !== DevWorkspaceStatus[DevWorkspaceStatus.RUNNING]) {
      this.saveDevfile();
    } else {
      this.setState({
